...
# メッセージにして送信
      ...
      await self.bot.send_message(message.channel, message.author.mention + msg)

    else:
      await self.bot.send_message(message.channel, message.content + "は対応していないか受信ができませんでした。")
